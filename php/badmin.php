...
function infotable($args)
{
	$count = $args["bytes"];
	echo <<<EOT
	<table class="four columns" style="margin-left:2%">
		<thead>
		<tr><th colspan="2"></th></tr>
		</thead><tbody>
			<tr><th>name</th><td>$args[name]</td></tr>
			<tr><th>map</th><td>$args[map]</td></tr>
			<tr><th>folder</th><td>$args[folder]</td></tr>
			<tr><th>game</th><td>$args[game]</td></tr>
			<tr><th>id</th><td>$args[id]</td></tr>
			<tr><th>players</th><td>$args[players]</td></tr>
			<tr><th>max players&nbsp;&nbsp;&nbsp;</th><td>$args[playersmax]</td></tr>
		</tbody>
	</table>
	...
	<table class="four columns" style="margin-left:2%">
		...
		<tbody>
			<tr><th>bots</th><td>$args[bots]</td></tr>
			<tr><th>server type</th><td>$args[server_type]</td></tr>
			<tr><th>environment</th><td>$args[environment]</td></tr>
			<tr><th>password</th><td>$args[password]</td></tr>
			<tr><th>vac</th><td>$args[vac]</td></tr>
			<tr><th>server time</th><td>$args[time]</td></tr>
			<tr><th>version</th><td>$args[version]</td></tr>
		</tbody>
	</table>
EOT;
}
...
EOT;
	...
	{
		echo "<tr>" . "<th>" . $args["$i"]["name"] . "&nbsp;&nbsp;" . "</th>" . "<td>" . $args["$i"]["rule"] . "</td>" . "</tr>";
	}
	echo <<<EOT
			</tbody>
		</table>
